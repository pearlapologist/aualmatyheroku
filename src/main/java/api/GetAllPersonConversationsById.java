 ...
 * @author bayan
 */
public class GetAllPersonConversationsById extends HttpServlet {
    ...
    protected void processRequest(HttpServletRequest request, HttpServletResponse response)
      ...
      ArrayList<Integer> persons =  db.getAllPersonConversationsById(id);
        ...
        for(int g : persons){
        JsonObjectBuilder oB2 = javax.json.Json.createObjectBuilder().add("person_id1", g);
       
            arrayBuilder.add(oB2);
        }
        
          objectBuilder.add("persons", arrayBuilder);
