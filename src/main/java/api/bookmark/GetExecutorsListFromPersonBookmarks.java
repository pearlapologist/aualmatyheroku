 ...
 * @author bayan
 */
public class GetExecutorsListFromPersonBookmarks extends HttpServlet {
    ...
    protected void processRequest(HttpServletRequest request, HttpServletResponse response)
      ...
      PrintWriter out = response.getWriter();
       ...
       int personId = -1;
        ...
        java.util.ArrayList<Bookmarks> executors = db.getExecutorsListFromPersonBookmarks(personId);
