 ...
 * @author bayan
 */
public class GetLeavedReviewPersonsIdList extends HttpServlet {
    ...
    protected void processRequest(HttpServletRequest request, HttpServletResponse response)
        ...
        ArrayList<Integer> r = db.getLeavedReviewPersonsIdList(personId);
        ...
        objectBuilder.add("ids", arrayBuilder.build());
