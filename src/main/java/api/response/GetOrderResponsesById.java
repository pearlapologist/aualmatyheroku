 ...
 * @author bayan
 */
public class GetOrderResponsesById extends HttpServlet {
    ...
    protected void processRequest(HttpServletRequest request, HttpServletResponse response)
        ...
        java.util.ArrayList<Response> responses = db.getAllOrderResponsesByOrderId(orderId);

        if (responses == null) {
            javax.json.JsonObjectBuilder objectBuilder = javax.json.Json.createObjectBuilder().
                    add("Ошибка", "Откликов не найдено");
        ...
        for (Response r : responses) {
            ...
            responseBuilderr.add("orderId", r.getOrderId());
            responseBuilderr.add("personId", r.getPersonId());
            responseBuilderr.add("text", r.getText());
            responseBuilderr.add("price", r.getPrice());
        ...
        builderr.add("responses", arrayBuilder);
