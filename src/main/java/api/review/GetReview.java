...
public class GetReview extends HttpServlet {
    ...
    protected void processRequest(HttpServletRequest request, HttpServletResponse response)
        ...
        builderr.add("executorId", r.getExecutrId());
        builderr.add("customerId", r.getCustomerId());
        builderr.add("text", r.getReview_text());
        builderr.add("assessment", r.getAssessment());
        ...
        for (AnswerToReview answer : r.getAnswers()) {
